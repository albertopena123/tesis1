...
<head>
    ...
    <link href="{{ asset('carga/pantalla.css') }}" type="text/css" rel="stylesheet" id="carga">
    @yield('css')
  
    <style>
        .active {
    color: forestgreen;
    /* Otros estilos que desees aplicar cuando el elemento está activo */
}
...
<body>
    ...
    <img src="assets/img/icons/logo.png" alt="Loading..." class="loader">
    </div>
                        ...
                        <li class="nav-item">
                            ...
                            @foreach ($slugs as $slug)
                                ...
                                <div class="nav-item-wrapper ">
                                    <a class="nav-link label-1 {{ request()->is('dashboard') ? 'active' : '' }}" href="{{route('dashboard')}}"
                                    role="button" data-bs-toggle="" aria-expanded="false">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                data-feather="compass"></span></span><span
                                            class="nav-link-text-wrapper"><span
                                                class="nav-link-text">Panel </span></span></div>
                                </a>
                            </div>
                                @endif

                                @if ($slug === 'US')
                                <div class="nav-item-wrapper"><a class="nav-link label-1 {{ request()->is('usuarios') ? 'active' : '' }}" href="{{ route('usuarios') }}"
                                    role="button" data-bs-toggle="" aria-expanded="false">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                data-feather="users"></span></span><span
                                            class="nav-link-text-wrapper"><span
                                                class="nav-link-text">Usuarios</span></span></div>
                                </a>
                            </div>
                                @endif
                            ...
                            <div class="nav-item-wrapper"><a class="nav-link label-1  {{ request()->is('operacion') ? 'active' : '' }}" href="{{route('operacion')}}"
                                    role="button" data-bs-toggle="" aria-expanded="false">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                data-feather="bell"></span></span><span
                                            class="nav-link-text-wrapper"><span
                                                class="nav-link-text">Definir Operacion</span></span></div>
                                </a>
                            </div><!-- parent pages-->
                                @endif
                                @if ($slug === 'GM')
                                <div class="nav-item-wrapper"><a class="nav-link label-1  {{ request()->is('gremios') ? 'active' : '' }}" href="{{route('gremios')}}"
                                    role="button" data-bs-toggle="" aria-expanded="false">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                data-feather="clock"></span></span><span
                                            class="nav-link-text-wrapper"><span
                                                class="nav-link-text">Gremios</span></span></div>
                                </a>
                            </div>
                                @endif

                                @if ($slug === 'CO')
                                <div class="nav-item-wrapper"><a class="nav-link label-1  {{ request()->is('carnets') ? 'active' : '' }}" href="{{route('carnets')}}"
                                    role="button" data-bs-toggle="" aria-expanded="false">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                data-feather="clock"></span></span><span
                                            class="nav-link-text-wrapper"><span
                                                class="nav-link-text">Carnet Operacional</span></span></div>
                                </a>
                            </div>
                                @endif
                    ...
                    <a class="navbar-brand me-1 me-sm-3" href="../index.html">
                        <div class="d-flex align-items-center">
                            <div class="d-flex align-items-center"><img src="../assets/img/icons/logo.png" alt="phoenix"
                                    width="27">
                                <p class="logo-text ms-2 d-none d-sm-block">DriverCheck</p>
                            </div>
                        </div>
                    </a>
                </div>
                                ...
                                <div class="overflow-auto scrollbar" style="height: 2rem;">
                                    <ul class="nav d-flex flex-column mb-2 pb-1">
                                        <li class="nav-item"><a class="nav-link px-3"
                                                href="{{ route('profile.show') }}"> <span class="me-2 text-body"
                                ...
                                <div class="card-footer p-0 border-top border-translucent">
                                    ...
                                    <form method="POST" action="{{ route('logout') }}" x-data>
                                        ...
                                        <div class="px-3"> <button
                                                class="btn btn-phoenix-secondary d-flex flex-center w-100" type="submit"
                                                href="#!"> <span class="me-2" data-feather="log-out"> </span>Cerrar Sesion</button>
                                        </div>
                                    </form>


                                    <div class="my-2 text-center fw-bold fs-10 text-body-quaternary"><a
                                            class="text-body-quaternary me-1" href="#!">Politicas Privacidad</a>&bull;
                    ...
                    <li class="nav-item">
                        <div class="theme-control-toggle fa-ion-wait pe-2 theme-control-toggle-slim"><input
                                ...
                                title="Switch theme"><span class="icon me-1 d-none d-sm-block"
                                    data-feather="moon"></span><span class="fs-9 fw-bold">Dark</span></label><label
                                class="mb-0 theme-control-toggle-label theme-control-toggle-dark"
                                for="themeControlToggle" data-bs-toggle="tooltip" data-bs-placement="left"
                                title="Switch theme"><span class="icon me-1 d-none d-sm-block"
                                    data-feather="sun"></span><span class="fs-9 fw-bold">Light</span></label></div>
                    </li>
            ...
            <div class="navbar-logo">
                ...
                <a class="navbar-brand me-1 me-sm-3" href="../index.html">
                    <div class="d-flex align-items-center">
                        <div class="d-flex align-items-center"><img src="../assets/img/icons/logo.png" alt="phoenix"
                                width="27">
                            <p class="logo-text ms-2 d-none d-sm-block">PlacaVision</p>
                        </div>
                    </div>
                </a>
            </div>
            ...
            <ul class="navbar-nav navbar-nav-icons flex-row">
                <li class="nav-item">
                    <div class="theme-control-toggle fa-icon-wait px-2"><input
                            ...
                            data-bs-toggle="tooltip" data-bs-placement="left" title="Cambiar Tema"><span class="icon"
                ...
                <li class="nav-item dropdown"><a class="nav-link lh-1 pe-0" id="navbarDropdownUser" href="#!"
                    ...
                    <div class="dropdown-menu dropdown-menu-end navbar-dropdown-caret py-0 dropdown-profile shadow border"
                        ...
                        <div class="card position-relative border-0">
                            ...
                            <div class="overflow-auto scrollbar" style="height: 10rem;">
                                <ul class="nav d-flex flex-column mb-2 pb-1">
                                    <li class="nav-item"><a class="nav-link px-3" href="{{ route('profile.show') }}">
                                    ...
                                    <li class="nav-item"><a class="nav-link px-3" href="#!"> <span
                                            ...
                                            Privacy </a></li>
                                    <li class="nav-item"><a class="nav-link px-3" href="#!"> <span
                                                class="me-2 text-body" data-feather="help-circle"></span>Help Center</a>
                                    </li>
                                    <li class="nav-item"><a class="nav-link px-3" href="#!"> <span
                                                class="me-2 text-body" data-feather="globe"></span>Language</a></li>
                                </ul>
        ...
        <div class="offcanvas-body scrollbar px-card" id="themeController">
            ...
            <div class="setting-panel-item">
                ...
                <div class="row gx-2">
                    ...
                    <div class="col-6"><input class="btn-checked" id="navbarPositionHorizontal" name="navigation-type"
    ...
    <script src="{{ asset('carga/pantalla.js') }}"></script>
